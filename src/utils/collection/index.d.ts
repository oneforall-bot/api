...
export declare class Collection<K, V> extends Map<K, V> {
     ...
     * @param {Function} fn Function that produces a new ftSecurity.Collection()
     * @param {*} [thisArg] Value to use as `this` when executing function
     * @returns {Collection}
     ...
     * [Array.map()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map).
     * @param {Function} fn Function that produces an element of the new ftSecurity.Collection(), taking three arguments
     * @param {*} [thisArg] Value to use as `this` when executing function
     * @returns {Collection}
    ...
    /**
     * Combines this collection with others into a new ftSecurity.Collection(). None of the source collections are modified.
